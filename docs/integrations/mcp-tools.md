...
- [ ] Crear estructura de carpetas `lib/ai/toolsets/`
- [ ] Implementar interfaces `BaseTool`, `BaseToolset`
- [ ] Implementar `ToolContext` enriquecido
- [ ] Implementar `ToolOrchestrator`
- [ ] Crear schemas Zod comunes

### Fase 2: Migración CRM Toolset (2-3 días)
- [ ] Migrar `get_contacts` a nueva arquitectura
- [ ] Migrar `search_contacts_deep`
- [ ] Migrar `get_contact_details`
- [ ] Migrar `get_contact_notes`, `create_note`
- [ ] Crear `CrmToolset`

### Fase 3: Migración Otros Toolsets (3-4 días)
- [ ] `CalendarToolset`: appointments
- [ ] `TasksToolset`: tareas
- [ ] `TeamToolset`: miembros del equipo
- [ ] `AnalyticsToolset`: métricas, funnel
- [ ] `MarketingToolset`: campañas (si aplica)

### Fase 4: Integración API Route (1-2 días)
- [ ] Refactorizar `/api/chat/route.ts` para usar `ToolOrchestrator`
- [ ] Actualizar modelo a `gemini-3-flash-preview`
- [ ] Implementar feature flag para rollout gradual
- [ ] Mantener backward compatibility

### Fase 5: Observabilidad y Testing (2-3 días)
- [ ] Implementar traces enriquecidos
- [ ] Dashboard de métricas de tools
- [ ] Tests unitarios para cada tool
- [ ] Tests de integración para toolsets

### Fase 6: Deprecación y Cleanup (1-2 días)
- [ ] Deprecar `lib/ai/tools.ts`
- [ ] Deprecar `lib/ai/tool-executor.ts`
