...
def _build_contact_update_user_prompt(contacto: dict, mensajes: list[dict], citas: list[dict]) -> str:
    ...
    return (
        ...
        "   - Idioma detectado\n"
        "   - Timezone IANA: si el contacto menciona su ciudad o país, infiere el timezone en formato IANA\n"
        "     (ej: 'Bogotá' → 'America/Bogota', 'México DF' → 'America/Mexico_City',\n"
        "      'Miami' → 'America/New_York', 'Madrid' → 'Europe/Madrid',\n"
        "      'Buenos Aires' → 'America/Argentina/Buenos_Aires', 'Lima' → 'America/Lima')\n"
        "     Solo guarda timezone si el campo actual está vacío o es null.\n\n"
