...
class KapsoInboundResponse(BaseModel):
    ...
    audio_url: str | None = Field(default=None, description="URL pública de audio si aplica")
    audio_caption: str | None = Field(default=None, description="Caption de audio si aplica")
    video_url: str | None = Field(default=None, description="URL pública de video si aplica")
    video_caption: str | None = Field(default=None, description="Caption de video si aplica")
